        ...
        <div class="card-body">
            <form action="{{ route('admin.packages.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('include_facilities') is-invalid @enderror" id="include_facilities" name="include_facilities" rows="3" required>{{ old('include_facilities') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('exclude_facilities') is-invalid @enderror" id="exclude_facilities" name="exclude_facilities" rows="3" required>{{ old('exclude_facilities') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('max_people') is-invalid @enderror" id="max_people" name="max_people" value="{{ old('max_people') }}" min="1" required>
                    @error('max_people')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('available_seats') is-invalid @enderror" id="available_seats" name="available_seats" value="{{ old('available_seats') }}" min="0" required>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file @error('image_url') is-invalid @enderror" id="image_url" name="image_url" required>
                    @error('image_url')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
